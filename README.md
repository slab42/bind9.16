...
Forked from mastermindg/rpi-dns - DNS for Raspberry Pi's over Docker and updated to use BIND 9.16
...
```bash
docker build -t slab42/bind9.16:arm64v8 github.com/slab42/bind9.16
```
